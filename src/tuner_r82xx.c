 ...
 *
 * Reference:
 *   Tektronix RSA306: -79.18 dBm correspond to -67.43 dB (LNA = 0, Mixer = 0, VGA = 8)
 *   (11.74 dB gain for VGA = 0x08)
 *
 ...
 *  At most 5 steps difference between the gains.
 */
...
static const int r82xx_lna_mixer_gain[][3] = {
    ...
    { 91,  1,  4}, { 99,  2,  2}, {104,  1,  5}, {105,  3,  0},
    {115,  2,  3}, {117,  3,  1}, {118,  1,  6}, {128,  2,  4},
    {136,  4,  0}, {141,  2,  5}, {148,  4,  1}, {150,  5,  0},
    {151,  3,  3}, {154,  2,  6}, {162,  5,  1}, {164,  4,  2},
    {166,  2,  7}, {176,  3,  5}, {178,  4,  3}, {179,  5,  2},
    {186,  6,  1}, {188,  4,  4}, {189,  3,  6}, {194,  5,  3},
    {200,  4,  5}, {201,  3,  7}, {202,  6,  2}, {206,  5,  4},
    {214,  4,  6}, {215,  3,  8}, {217,  6,  3}, {218,  5,  5},
    {225,  7,  2}, {228,  4,  7}, {230,  6,  4}, {231,  5,  6},
    {241,  7,  3}, {244,  6,  5}, {256,  7,  4}, {259,  4,  9},
    {260,  6,  6}, {262,  5,  8}, {270,  8,  3}, {277,  5,  9},
    {285,  8,  4}, {289,  6,  8}, {291,  5, 10}, {298,  8,  5},
    {299,  7,  7}, {303,  6,  9}, {312,  8,  6}, {314,  7,  8},
    {316,  9,  5}, {318,  6, 10}, {328,  7,  9}, {331,  9,  6},
    {341,  8,  8}, {343,  7, 10}, {345,  9,  7}, {356,  8,  9},
    {359,  9,  8}, {363, 10,  8}, {368, 12,  7}, {374,  9,  9},
    {378, 10,  9}, {383, 12,  8}, {384,  8, 11}, {387, 11,  9},
    {389,  9, 10}, {390, 13,  8}, {392, 10, 10}, {397,  8, 12},
    {398, 12,  9}, {402, 11, 10}, {404, 10, 11}, {405, 13,  9},
    {413, 12, 10}, {414, 11, 11}, {417, 10, 14}, {419, 13, 10},
    {421, 14,  9}, {425, 11, 15}, {426, 12, 11}, {432, 13, 11},
    {436, 14, 10}, {438, 12, 13}, {443, 13, 15}, {444, 13, 14},
    {445, 15, 10}, {450, 14, 11}, {458, 15, 11}, {462, 14, 12},
    {463, 14, 13}, {464, 14, 14}, {465, 15, 15}, {468, 15, 13},
    {469, 15, 14}, {470, 15, 12}
};
